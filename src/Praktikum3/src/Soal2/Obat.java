...
public class Obat {
    ...
    public static Obat[] daftarObat(Obat[] obat) {
        ...
        String[] namaObat = {"Parasetamol", "Antalgin", "Tetrasiclin", "Neosep Forte", "Paramex Plus"};
        int[] hargaObat = {10000, 9000, 8000, 7000, 6000};
    ...
    public static void pesananObat(String[] pesanan, Obat[] obat, User user) {
        int total = 0;
